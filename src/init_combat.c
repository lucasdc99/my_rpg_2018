...
static void init_sprites(window_t *win)
{
    ...
    get_pos_float(350, 50));
    init_sprite(&win->scene[COMBAT].sprite[3], "ressources/background_fight.png",
    get_pos_float(0, 0));
    init_sprite(&win->scene[COMBAT].sprite[4], "ressources/platform_fight.png",
    get_pos_float(260, 620));
    init_sprite(&win->scene[COMBAT].sprite[5], "ressources/platform_fight.png",
    get_pos_float(1510, 620));
    init_sprite(&win->scene[COMBAT].sprite[6], "ressources/test_fight.png",
    get_pos_float(0, 0));
