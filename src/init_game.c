...
window_t *init_game(window_t *win)
{
    ...
    win->scene[GAME].text = malloc(sizeof(text_t) * 1);
    win->scene[GAME].nb_text = 1;
    ...
    init_sprite(&win->scene[GAME].sprite[0], "ressources/pack/Pixel_Champions/Magical Heroes/Prime-the-Great-Sage.png", get_pos_float(100, 100));
