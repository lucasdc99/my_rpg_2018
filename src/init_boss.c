...
static void initialisation_depth_sprite_boss_one(window_t *win)
{
    ...
    "ressources/images/statue.png", get_pos_float(582, 372));
...
static void initialisation_depth_sprite_boss(window_t *win)
{
    ...
    "ressources/images/colomn.png", get_pos_float(732, 530));
    init_sprite(&win->scene[BOSS].sprite[11],
    "ressources/images/colomn.png", get_pos_float(1047, 532));
    init_sprite(&win->scene[BOSS].sprite[12],
    "ressources/images/colomn.png", get_pos_float(728, 734));
    init_sprite(&win->scene[BOSS].sprite[13],
    "ressources/images/colomn.png", get_pos_float(1048, 733));
    init_sprite(&win->scene[BOSS].sprite[14],
    "ressources/images/colomn.png", get_pos_float(727, 933));
    init_sprite(&win->scene[BOSS].sprite[15],
    "ressources/images/colomn.png", get_pos_float(1045, 935));
