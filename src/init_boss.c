...
static void initialisation_depth_sprite_boss(window_t *win)
{
    ...
    init_sprite(&win->scene[BOSS].sprite[8], "ressources/sprite_contraste/colomn.png", get_pos_float(731, 335));
    init_sprite(&win->scene[BOSS].sprite[9], "ressources/sprite_contraste/colomn.png", get_pos_float(1048, 337));
    init_sprite(&win->scene[BOSS].sprite[10], "ressources/sprite_contraste/colomn.png", get_pos_float(732, 530));
    init_sprite(&win->scene[BOSS].sprite[11], "ressources/sprite_contraste/colomn.png", get_pos_float(1047, 532));
    init_sprite(&win->scene[BOSS].sprite[12], "ressources/sprite_contraste/colomn.png", get_pos_float(728, 734));
    init_sprite(&win->scene[BOSS].sprite[13], "ressources/sprite_contraste/colomn.png", get_pos_float(1048, 733));
    init_sprite(&win->scene[BOSS].sprite[14], "ressources/sprite_contraste/colomn.png", get_pos_float(727, 933));
    init_sprite(&win->scene[BOSS].sprite[15], "ressources/sprite_contraste/colomn.png", get_pos_float(1045, 935));
    init_sprite(&win->scene[BOSS].sprite[16], "ressources/sprite_contraste/flambeau.png", get_pos_float(773, 219));
    init_sprite(&win->scene[BOSS].sprite[17], "ressources/sprite_contraste/flambeau.png", get_pos_float(1010, 221));
}
