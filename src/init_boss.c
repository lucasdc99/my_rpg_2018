...
window_t *init_boss(window_t *win)
{
    ...
    init_sprite(&win->scene[BOSS].sprite[1], "ressources/pack/Pixel_Champions/Magical Heroes/Glenys-the-Demonswordsman.png", get_pos_float(920, 80));
    ...
    sfSprite_setTextureRect(win->scene[BOSS].sprite[1].sprite, get_rect(12, 9, 32, 32));
