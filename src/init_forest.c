...
static void initialisation_sprite_forest_one(window_t *win)
{
    ...
    "ressources/forest.png", get_pos_float(0, 0));
    init_sprite(&win->scene[FOREST].sprite[1],
    "ressources/sprite_contraste/tree.png", get_pos_float(30, 245));
    init_sprite(&win->scene[FOREST].sprite[2],
    "ressources/sprite_contraste/tree.png", get_pos_float(55, 10));
    init_sprite(&win->scene[FOREST].sprite[3],
    "ressources/sprite_contraste/tree.png", get_pos_float(125, 95));
    init_sprite(&win->scene[FOREST].sprite[4],
    "ressources/sprite_contraste/tree.png", get_pos_float(545, 3));
    init_sprite(&win->scene[FOREST].sprite[5],
    "ressources/tree2.png", get_pos_float(335, 210));
