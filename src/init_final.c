...
window_t *init_final(window_t *win)
{
    ...
    init_sprite(&win->scene[FINAL].sprite[1], "TimeFantasy_TILES_6.24.17/TILESETS/animated/doors.png", get_pos_float(1019, 37));
    ...
    sfSprite_setTextureRect(win->scene[FINAL].sprite[1].sprite, get_rect(176, 128, 16, 27));
