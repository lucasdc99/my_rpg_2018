...
window_t *init_choose_heroes(window_t *win)
{
    ...
    init_text(&win->scene[HEROES].text[1], "Hex-the-Time-Witch", get_pos_float(pos_window.x / 2, 100));
    init_text(&win->scene[HEROES].text[2], "Life: ", get_pos_float((pos_window.x - 100) / 2, (size_window.y - 450)));
    init_text(&win->scene[HEROES].text[3], my_itc(70), get_pos_float((pos_window.x + 250) / 2, (size_window.y - 450)));
    init_text(&win->scene[HEROES].text[4], "Strength: ", get_pos_float((pos_window.x - 200) / 2, (size_window.y - 350)));
    init_text(&win->scene[HEROES].text[5], my_itc(70), get_pos_float((pos_window.x + 250) / 2, (size_window.y - 350)));
