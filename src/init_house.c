...
window_t *init_house(window_t *win)
{
    ...
    init_sprite(&win->scene[HOUSE].sprite[0], "ressources/town.png", get_pos_float(0, 0));
    init_sprite(&win->scene[HOUSE].sprite[1], "ressources/inventory.png", get_pos_float(-600, -300));
